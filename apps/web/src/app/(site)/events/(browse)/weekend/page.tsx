...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = `Events in Manchester This Weekend — ${rangeLabel}`;
  const description = `${countLabel} in Manchester this weekend (${rangeLabel}). Gigs, nightlife, shows, and more on HappenMCR.`;
